...
const checkMediaNumber = (num1, num2, num3, num4) => {
  if (typeof num1 !== 'number' || typeof num2 !== 'number' || typeof num3 !== 'number' || typeof num4 !== 'number') {
    throw new Error('São necessários 4 números.')
  }
}

const mediaChecker = (num1, num2, num3, num4) => {
  try {
    checkMediaNumber(num1, num2, num3, num4)
